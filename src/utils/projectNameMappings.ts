...
export const projectNameMappings: ProjectNameMapping[] = [
  {
...
export function getNormalizedProjectName(projectName: string): string {
  const mapping = projectNameMappings.find(m => m.original === projectName);
